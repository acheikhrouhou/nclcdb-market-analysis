...
/**
 * LC/NC Database — Pricing & FAQ (TypeScript)
 * Single-file React component with Tailwind CSS classes
 * Save as `PricingPage.tsx`
 */
...
const addOns: AddOn[] = [
  { title: "Automation Credits", detail: "$5 = 2,500 runs (12-month rolling validity)" },
  { title: "Premium Connectors", detail: "+$10 / editor / mo (incl. in Business)" },
  { title: "Extra Storage", detail: "+$2 / 10 GB" },
  { title: "External Users", detail: "After 50 free (Business): $3 / user / mo" },
...
const PricingPage: React.FC = () => {
  ...
  const displayPlans = useMemo<Plan[]>(() => {
    // Extend here if you want to compute monthly vs annual prices
    return plans;
  }, []);
          ...
          <div className="mt-6 rounded-2xl bg-gray-50 border border-dashed border-gray-300 p-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="h-2 w-40 bg-white rounded-full shadow-inner overflow-hidden" aria-label="credit usage">
...
// -----------------------------
interface DisclosureProps { q: string; a: string }

function Disclosure({ q, a }: DisclosureProps) {
  ...
  return (
    <div className="px-5 py-4">
      ...
      >
        ...
        <svg
          className={classNames("h-5 w-5 transition-transform", open ? "rotate-180" : "rotate-0")}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          aria-hidden="true"
